...
import com.example.ravivats.worknopsysmobile.Others.QRScanInfo;
...
public class TinyDB {
    ...
    public List<List<QRScanInfo>> getOwnListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<List<QRScanInfo>> objects =  new ArrayList<>();
        List<QRScanInfo> x = new ArrayList<>();

        for(String jObjString : objStrings){
            List<QRScanInfo> value  = gson.fromJson(jObjString,  x.getClass());
            objects.add(value);
        }
    ...
    public void putOwnListObject(String key, List<List<QRScanInfo>> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(List<QRScanInfo> obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
